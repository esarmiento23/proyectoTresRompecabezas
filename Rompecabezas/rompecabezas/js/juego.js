...
var instrucciones = ['Deberas ordernar las piezas del rompecabezas de la derecha.',
  'Utiliza las flechas de tu teclado para mover las piezas.',
  'La imagen objetivo se encuentra debajo.',
  'BUENA SUERTE!'];
...
function chequearSiGano() {
  ...
  if (grillaGanadora.length != grilla.length) {
    return sonIguales;
  }

  for (var i = 0; i < grillaGanadora.length; i++) {


    if (grillaGanadora[i].length != grilla[i].length) {
      sonIguales = false;
      break;
    }
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  ...
  intercambiador = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = intercambiador;
